# fairmat-project-outputs

A NOMAD plugin providing a unified schema for documenting and managing FAIRmat project outputs, including events and publications.
...
```sh
git clone https://github.com/foo/fairmat-project-outputs.git
cd fairmat-project-outputs
